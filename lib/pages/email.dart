...
class EmailSender extends StatefulWidget {
  const EmailSender({Key? key, required this.text, this.id}) : super(key: key);
  final String text;
  final id;
  @override
...
class _EmailSenderState extends State<EmailSender> {
  ...
  late final _subjectController =
      TextEditingController(text: 'congratulations');

  final _bodyController = TextEditingController(
    text:
        'Congratulations, you have been accepted into the job .\n If you receive this email we hope you will reply to it as soon as possible',
  );
