...
class FilterNetworkPage extends StatefulWidget {
  @override
  FilterNetworkPageState createState() => FilterNetworkPageState();
  const FilterNetworkPage({
    Key? key,
    required this.user,
  }) : super(key: key);
  final User user;
...
class FilterNetworkPageState extends State<FilterNetworkPage> {
  List<Book> books = [];
  ...
  Widget build(BuildContext context) => Scaffold(
      appBar:
          ...
          AppBar(
        title: Text("Business that suits you"),
        //     leading: buildSearch(),
        /*    leading: IconButton(
      ...
      body: Padding(
          ...
          child: FutureBuilder(
            //   future: getProjects(),
            initialData: searchBook(widget.user.sp.toString()),
  ...
  Future searchBook(String query) async => debounce(() async {
        query = widget.user.skills.toString();
        final books = await BooksApi.getBooks(query);
