...
import 'package:untitled4/pages/ss.dart';

import '../SearchWidget.dart';
import '../models/users.dart';
import '../shared_components/colors.dart';

class searg extends StatefulWidget {
  @override
  seargPageState createState() => seargPageState();
  const searg({
    Key? key,
    required this.user,
  }) : super(key: key);
...
class seargPageState extends State<searg> {
  List<ACC> books = [];
