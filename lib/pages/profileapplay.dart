...
import 'package:untitled4/pages/mywork1.dart';
import 'package:url_launcher/url_launcher.dart';

import '../models/users.dart';

class profileapplay extends StatefulWidget {
  const profileapplay({Key? key, required this.user, this.rate, this.number})
      : super(key: key);
  final Pro user;
  final rate, number;

  @override
  _profileapplayState createState() => _profileapplayState();
}

class _profileapplayState extends State<profileapplay> {
  String rate = '';
  String number = '';
  String image = '';
...
/*
  ...
  Future<double> getRate() async {
    http
        .get(Uri.parse(
            'http://192.168.1.78/api_dev/api_dev/pro/user_rate.php?idusers=' +
