...
class MyStyles {
  ...
  TextStyle normalBlack = const TextStyle(
      ...
      fontFamily: 'Quicksand');
  TextStyle smallBlack = const TextStyle(
      color: Colors.black,
  ...
  TextStyle normalWhite = const TextStyle(
      ...
      fontFamily: 'Quicksand');
  TextStyle normalGrey =
      TextStyle(fontSize: 14, color: Colors.grey[600], fontFamily: 'Quicksand');
  ...
  TextStyle hintText = const TextStyle(
      ...
      fontWeight: FontWeight.w600,
      fontFamily: 'Quicksand');
  TextStyle barText1 = TextStyle(
      fontSize: 16,
      color: Colors.grey[800],
      fontWeight: FontWeight.w900,
      fontFamily: 'Quicksand');
  TextStyle barText2 = TextStyle(
      fontSize: 14,
